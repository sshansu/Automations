...
#$Admincred = Get-Credential -UserName admin@MngEnvMCAP722212.onmicrosoft.com -Message "Enter Password"
$subcriptionID =""
$resourceGroup = ""
$location = "eastus2"
...
#$subscriptionContext = Select-AzSubscription -Subscription $subcriptionID

# Setting Azure Context 
#Set-AzContext -Subscription "ME-MngEnvMCAP722212-sshansu-2"

#Get-AzResourceGroup -Name SpaceNet | remove-azresourcegroup -Force
