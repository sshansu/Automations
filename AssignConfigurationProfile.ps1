	        ...
	        assignments = @(
		        @{
			        target = @{
				        ...
				        groupId = "1b46f9bb-1f5c-486c-b5fa-181af9c956a6"
			        }
		        }
	        )
            }
                    ...
                    try
                        {
                            ...
                            Write-Host "Assigned $($PolicyName)" -ForegroundColor Cyan
                        }
                    catch
                        {
...
Assign-DeviceConfigurationPolicy -Assign All -PolicyType SettingsCatalog
