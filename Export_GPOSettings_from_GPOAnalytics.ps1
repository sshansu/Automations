...
$ExportPath = "C:\Users\sshansu\OneDrive - Microsoft\CX\_BAT\Wave 4\Automation\PolicySettings"
...
$PolicyNames = (import-csv "C:\Users\sshansu\OneDrive - Microsoft\CX\_BAT\Wave 4\Automation\SupportedPolicyList\FinalPolicyList.csv").ContributingPolicy
foreach($GPO in $PolicyNames)
    {
        #Write-host "Working on $gpo" -ForegroundColor Cyan
        Export-GPOConfiguration -PolicyName $GPO -ExportPath "C:\Users\sshansu\OneDrive - Microsoft\CX\_BAT\Wave 4\Automation\PolicySettings"
    }
